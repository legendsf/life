package com.sf.jkt.k.comp.javaagent.advice;
...
class AdviceProfiledInterceptor {
  ...
  static long enter(@Advice.This Object thisObj,@Advice.Origin("#m") String methodName,
                    @Advice.Argument(value = 0) int sleepTime,
                     @Advice.Argument(value = 1) String invalidParam) {
    System.out.println("======thisObj is"+thisObj+"======= sleep time is " + sleepTime + ", invalid param is " + invalidParam + "=======");
    int i = 1/0;
    System.out.println("~~~~~~~");
