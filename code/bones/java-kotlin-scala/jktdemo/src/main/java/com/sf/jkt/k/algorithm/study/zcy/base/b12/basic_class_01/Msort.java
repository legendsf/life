...
public class Msort {
    ...
    public static int[] selectionSort5(int[] arr){
        for(int i=0;i<arr.length-1;i++){ //[0,N-2] 外围轮次
           int minIndex=i;
           for(int j=i+1;j<arr.length;j++ ){
...
//            Constants.checkSort(Code_02_SelectionSort::selectionSort);
            Constants.checkSort(Msort::bubbleSort1);
            Constants.checkSort(Msort::selectionSort5);
        }
}
