...
import static com.sf.jkt.k.algorithm.vrptw.ts.EvaluateRoute.UpdateSubT;
import static com.sf.jkt.k.algorithm.vrptw.ts.Parameter.*;
...
public class InitAndPrint {
	...
	public static void ReadIn(){
		...
		try {
			URL absfile= InitAndPrint.class.getResource("/ts/c101.txt");
			File file=new File(absfile.getFile());
