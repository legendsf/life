//package com.sf.jkt.k.biz.bigdata.spark.java.streamClick.yore.dt;
//
//import com.sf.jkt.k.biz.bigdata.spark.scala.stream.spark.JDBCWrapper;
//import com.sf.jkt.k.biz.bigdata.spark.scala.stream.spark.PropertiesUtil;
...
//import scala.Tuple2;
//import com.sf.jkt.k.biz.bigdata.spark.java.streamClick.yore.db.*;
//
...
//                        );
//
//                        JavaPairRDD<String, Tuple2<Tuple2<String, String>, java.util.Optional<Boolean>>> joined = rdd2Pair.leftOuterJoin(blackListRDD);
//
//                        JavaPairRDD<String, String> result = joined.filter(
//                                new Function<Tuple2<String, Tuple2<Tuple2<String, String>, java.util.Optional<Boolean>>>, Boolean>() {
//                                    @Override
//                                    public Boolean call(Tuple2<String, Tuple2<Tuple2<String, String>, java.util.Optional<Boolean>>> v1) throws Exception {
//                                        java.util.Optional<Boolean> optional = v1._2._2;
//
...
//                                }
//                        ).mapToPair(
//                                new PairFunction<Tuple2<String, Tuple2<Tuple2<String, String>, java.util.Optional<Boolean>>>, String, String>() {
//                                    @Override
//                                    public Tuple2<String, String> call(Tuple2<String, Tuple2<Tuple2<String, String>, java.util.Optional<Boolean>>> t) throws Exception {
//                                        return t._2._1;
//                                    }
//                                }
//                        );
...
//                }
//        ).updateStateByKey(
//                new Function2<List<Long>, java.util.Optional<Long>, java.util.Optional<Long>>() {
//                    /**
//                     * v1: 代表当前的key在当前的Batch Duration中出现次数的集合，如{1,1,1,1,1,1}
//                     * v2: 代表当前key在一起拿的BatchDuration中积累下来的结果
//                     */
//                    @Override
//                    public java.util.Optional<Long> call(List<Long> v1, java.util.Optional<Long> v2) throws Exception {
